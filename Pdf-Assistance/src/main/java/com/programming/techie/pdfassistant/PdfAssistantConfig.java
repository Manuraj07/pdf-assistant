...
public class PdfAssistantConfig {
    ...
    public AstraDbEmbeddingStore astraDbEmbeddingStore() {
        String astraToken = "AstraCS:jOCpZbvoxihlWZWLjaoOhkZR:1b6ba9533cd86056c1f7bc4396e4946f224974ebb9b0e801c2dbc68d917761b9";
        String databaseId = "f21d7d79-8d23-4737-87c0-fd4b4953f9e2";
    ...
    public ConversationalRetrievalChain conversationalRetrievalChain() {
        return ConversationalRetrievalChain.builder()
                .chatLanguageModel(OpenAiChatModel.withApiKey("f21d7d79-8d23-4737-87c0-fd4b4953f9e2"))
